...
const testimonials = [
  ...
  },
  {
    name: 'Luis Rodríguez',
    feedback:
      'Los reportes estadísticos nos han ayudado a tomar mejores decisiones.',
    image: '/men2.jpg',
  },
];
    ...
    <div className='min-h-screen bg-gray-100 text-gray-900 p-8'>
      ...
      >
        ...
        <p className='text-gray-600 text-lg'>
          Descubre cómo optimizar la productividad con estadísticas y
          testimonios.
        </p>
      </motion.div>
        ...
        <div className='flex flex-col gap-6'>
          ...
          >
            ...
            <div>
              ...
              <p className='text-gray-600'>
                Recibe opiniones y mejora continuamente.
              </p>
            </div>
          </motion.div>
